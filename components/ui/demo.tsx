...
const defaultCards = [
  {
    icon: <Terminal className="size-5 sm:size-7 text-emerald-300 keep-emerald-icon" />,
    title: "SecOps",
  ...
  {
    icon: <Activity className="size-5 sm:size-7 text-teal-300 keep-teal-icon" />,
  ...
  {
    icon: <Lock className="size-5 sm:size-7 text-amber-400 fill-amber-400/20 stroke-amber-500 stroke-[1.5] keep-amber-lock" />,
    title: "EHR Isolation",
    description: "Zero-trust network configuration",
    date: "Deployed",
    iconClassName: "text-amber-400 keep-amber-lock",
    titleClassName: "text-white font-serif keep-bright-white",
